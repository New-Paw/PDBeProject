...
Images are in public domain, not copyrighted, no rights reserved, free for any
use. You can use pictures for any personal and commercial use without the prior
written permission and without fee or obligation.
...
The images were converted from JPEG to GIF by
`convert image.jpg -resize 400x400 -layers Optimize image.gif`.
